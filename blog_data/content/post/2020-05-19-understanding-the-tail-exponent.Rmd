...
That is, we can see that the degree of dominance by the tail events is convex to the value of $\alpha$. **Thus, the lower the $alpha$, the fatter the tail, and the larger dominance of the phenomena by the tail events**.
